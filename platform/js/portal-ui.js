...
class PortalUI {
        ...
        header.innerHTML = `
            <div class="container mx-auto px-6 py-4 flex justify-between items-center">
                <div class="flex items-center gap-4">
                    <div class="h-10 w-10 bg-amber-500 rounded-lg flex items-center justify-center font-black text-black">V</div>
                    <h1 class="text-2xl font-black tracking-tighter text-white uppercase hidden md:block">Vindicta <span class="text-amber-500">Portal</span></h1>
                </div>
            ...
            <div class="container mx-auto px-6 py-12">
                <div class="grid md:grid-cols-4 gap-12 mb-12">
                    <div class="col-span-2">
                        <div class="text-2xl font-black tracking-tighter text-white uppercase mb-4">VINDICTA <span class="text-amber-500">PORTAL</span></div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-sm text-gray-500">
                            <li><a href="#" class="hover:text-amber-500 transition-colors">Meta-Oracle</a></li>
                            <li><a href="#" class="hover:text-amber-500 transition-colors">Gas Tank</a></li>
                            <li><a href="#" class="hover:text-amber-500 transition-colors">WARScribe</a></li>
                        </ul>
                    </div>
                    <div>
                ...
                <div class="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex gap-6">
                        <span class="text-[10px] text-amber-500/40 uppercase tracking-widest font-bold">UNOFFICIAL / THIRD-PARTY PLATFORM</span>
                    </div>
                </div>
            </div>
        `;
    ...
    static showToast(message) {
        ...
        if (!toast) {
            ...
            toast.className = "fixed bottom-8 right-8 z-[100] bg-amber-500 text-black font-black uppercase text-xs tracking-widest px-6 py-4 rounded-lg shadow-2xl transition-all translate-y-20 opacity-0";
